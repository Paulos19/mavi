...
export function Sidebar() {
  ...
  // Buscar métricas (Assistente vê APENAS os seus tickets)
  useEffect(() => {
    if (status === "authenticated") {
      setIsLoadingMetrics(true);
      // A API /api/tickets já está filtrada por assistente
      fetch('/api/tickets')
        .then(res => res.json())
        ...
        .catch(err => console.error("Erro ao buscar métricas da sidebar:", err))
  ...
  const userName = session?.user?.name || "Assistente";
          ...
          <AnimatePresence>
            {!isRetracted && (
              ...
              >
                ...
                {/* Barra de Progresso (Métricas Pessoais) */}
